function dispVertPET_instances(pd_idx)
    ...
    vert3d = cat(3, zs, vertStruct(1).pt_data, zs, ...
                        ...
                        vertStruct(18).pt_data, zs, ...
                        vertStruct(19).pt_data, zs, ...
                        vertStruct(20).pt_data, zs, ...
                        vertStruct(21).pt_data, zs, ...
                        vertStruct(22).pt_data, zs, ...
                        vertStruct(23).pt_data, zs);
    ...
    fv0 = isosurface(vert3d, 0.0000001);
