...
F3. FLT-PET SUV extraction. Extracts total SUV content of a volume
    segmentation.
    - "getSUV_byClass.m": extracts total SUV from associated mask and
    ...
    - "SUV_wrapper.m": a wrapper for calculating total SUV from a
    ...
    - "SUV_dilateAxialPlane.m": function used with "createVertStruct"
